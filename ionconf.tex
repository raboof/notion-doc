...
\section{Functions exported by \file{ioncore}}
\label{sec:ioncoreref}
\input{ioncore-fns.tex}

\section{Functions exported by \file{mod\_ionws}}
\label{sec:ionwsref}
\input{mod_ionws-fns.tex}

\section{Functions exported by \file{mod\_floatws}}
\label{sec:floatwsref}
\input{mod_floatws-fns.tex}

\section{Functions exported by \file{mod\_query}}
\label{sec:queryref}
\input{mod_query-fns.tex}

\section{Functions exported by \file{mod\_menu}}
\label{sec:menuref}
\input{mod_menu-fns.tex}

\section{Functions exported by \file{mod\_dock}}
\label{sec:dockref}
\input{mod_dock-fns.tex}

\section{Functions exported by \file{mod\_sp}}
\label{sec:spref}
