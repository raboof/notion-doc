...
\code{frame-tiled-ionws} & A more specific style for frames on tiled
        workspaces. Substyles as for \code{frame}. \\
\code{frame-floating-floatws} & A more specific style for frames on
        floating workspaces. Substyles as for \code{frame}. \\
\end{tabularx}
...
\code{tab-frame-tiled-ionws} & A more specific tab style for
        \code{frame-tiled-ionws} frames. \\
\code{tab-frame-floating-floatws} & A more specific style for 
        \code{frame-floating-floatws} frames. \\
...
\subsection{Extra fields for style \code{frame-tiled-ionws}}

\begin{tabularx}{\linewidth}{lX}
\tabhead{Field  & Description}
\code{ionframe_bar_inside_border} & Controls whether the tab-bar
	appears inside or outside of the frame's borders. true/false.
\end{tabularx}

\subsection{Extra fields for style \code{frame-floating-floatws}}
	
\begin{tabularx}{\linewidth}{lX}
\tabhead{Field  & Description}
\code{floatframe_tab_min_w} & Minimum tab width in pixels, given
