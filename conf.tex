...
The special menus ''windowlist'' and ''workspacelist'' are predefined
by \file{menulib}. These are lists of client windows and  workspaces,
respectively and may be used where normally defined menus, as explained
above, are used.
