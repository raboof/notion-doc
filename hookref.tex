...
\begin{function}
    ...
    \hookparams{(WRegion, string, WRegion)}
    \begin{funcdesc}
      ...
      \begin{tabularx}{\linewidth}{llX}
          \tabhead{String & Detail & Description}
          ...
          \code{sub-activity} & & There's been activity in some sub-region. \\
          \code{name} & & The name of the region has changed. \\
          \code{unset_manager} & Old manager & The region no longer has a manager. \\
          \code{set_manager} & New manager & The region now has a manager. \\
